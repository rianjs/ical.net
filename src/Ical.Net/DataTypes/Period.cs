...
public class Period : EncodableDataType, IComparable<Period>
{
    ...
    protected bool Equals(Period other)
        => Equals(StartTime, other.StartTime) && Equals(EndTime, other.EndTime) && Duration.Equals(other.Duration);
    ...
    public override int GetHashCode()
        => HashCode.Combine(StartTime, EndTime, Duration).GetHashCode();
    ...
    public virtual bool CollidesWith(Period period)
        => period is not null
           && ((period.StartTime is not null && Contains(period.StartTime)) || (period.EndTime != null && Contains(period.EndTime)));
