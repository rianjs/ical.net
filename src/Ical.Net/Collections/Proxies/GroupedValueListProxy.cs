...
/// </summary>
public class GroupedValueListProxy<TGroup, TInterface, TItem, TOriginalValue, TNewValue> : List<TNewValue>
    ...
    where TItem : new()        
{
    ...
    public new virtual void Add(TNewValue item)
    {
    ...
    public new virtual bool Contains(TNewValue item) => Items.Any(o => o.ContainsValue((TOriginalValue)(object)item));

    public new virtual void CopyTo(TNewValue[] array, int arrayIndex)
    {
        Items                
    ...
    public new virtual int Count => Items.Sum(o => o.ValueCount);

    public virtual bool IsReadOnly => false;

    public new virtual bool Remove(TNewValue item)
    {
        if (!(item is TOriginalValue))
        {
            return false;
    ...
    public new virtual IEnumerator<TNewValue> GetEnumerator() => GetEnumeratorInternal();

    public new virtual int IndexOf(TNewValue item)
    {
        var index = -1;
    ...
    public new virtual void Insert(int index, TNewValue item)
    {
        IterateValues((o, i, count) =>
        {
            var value = (TOriginalValue)(object)item;
    ...
    public new virtual TNewValue this[int index]
    {
        get
        {
